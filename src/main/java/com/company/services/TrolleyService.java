...
import com.company.repository.TrolleyRepository;
...
public class TrolleyService {
    ...
    public void update(UserDetails userDetails) {
        List<TrolleyProduct> trolleyProducts = rep.trolleyAll(userDetails.getAuthUser().getId());
